...
export default defineConfig({
  ...
  presets: [presetAttributify(), presetUno(), presetIcons(), presetScalpel()],
  shortcuts: {
    ...
    "bi-2": "flex items-center justify-center min-h-160 h-160 w-fill bg-dark-500",
    "bi-3": "max-w-520px line-clamp-3",
    "ft-c": "border-t-solid border-t-color-dark-500 flex items-center justify-start",
    "ft-n": "flex flex-direction-row ml-3 mr-3 mt-6 mb-6 column-gap-20",
    "ft-l": `flex items-center mt-3 border-rounded-1 hover:bg-${theme}-700 transition-all pl-3 pr-3 pt-1 pb-1`,
    "fl-1": "flex items-center justify-center ml-2",
    "fl-2": `w-6 h-6 mr-2 bg-${theme}-700 b-rounded-full`,
    ...
    "f-3": "flex justify-start flex-wrap text-base gap-5 mb-5 mt-3",
    "f-4": "ml-2 mr-2 mt-4",
    ...
    "ba-c": "mt-2 h-150 flex items-center justify-start pl-4 max-w-350px w-fill bg-dark-500 border-rounded-2",
    ...
    "flex-c": "flex flex-direction-column",
